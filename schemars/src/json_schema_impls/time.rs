...
impl JsonSchema for Duration {
    ...
    fn json_schema(generator: &mut SchemaGenerator) -> Schema {
        ...
        obj.properties.insert("secs".to_owned(), <u64>::json_schema(generator));
        obj.properties.insert("nanos".to_owned(), <u32>::json_schema(generator));
        schema.into()
    }
}
...
impl JsonSchema for SystemTime {
    ...
    fn json_schema(generator: &mut SchemaGenerator) -> Schema {
        ...
        obj.properties.insert("secs_since_epoch".to_owned(), <u64>::json_schema(generator));
        obj.properties.insert("nanos_since_epoch".to_owned(), <u32>::json_schema(generator));
        schema.into()
    }
}
